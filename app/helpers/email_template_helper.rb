module EmailTemplateHelper
  ...
  # Ok, some madness ahead. There seems to be a bug in rails as documented http://www.candland.net/2012/04/17/rails-routes-used-in-an-isolated-engine/
  # where including the URL helpers will cause all other
